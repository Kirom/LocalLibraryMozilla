...
class AuthorListViewTest(TestCase):
    ...
    def test_pagination_is_ten(self):
        ...
        self.assertTrue(len(resp.context['author_list']) == 6)
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def setUp(self):
        ...
        test_superuser1 = User.objects.create_superuser(username='testsuperuser1', password='12345', is_staff=True)
    ...
    def test_redirects_to_all_borrowed_book_list_on_success(self):
        login = self.client.login(username='testsuperuser1', password='12345')
        ...
        self.assertRedirects(resp, reverse('on-loan'))
